...
public class RSAUtil {
    ...
    public static Map<String,String> generateKeyPair(String filePath){  
        try {  
            ...
            System.out.println("N:"+((RSAPublicKey)publicKey).getModulus());
            System.out.println("e:"+((RSAPublicKey)publicKey).getPublicExponent());
            // 私钥  
            PrivateKey privateKey = keyPair.getPrivate();  
            
            System.out.println("d:"+((RSAPrivateKey)privateKey).getPrivateExponent());
            //得到公钥字符串  
...
//    	generateKeyPair("D:/RSA");
    	...
    	try {
			RSAPublicKey pkey=(RSAPublicKey)getPublicKey(publicKey);
			RSAPrivateKey prKey=(RSAPrivateKey)getPrivateKey(privateKey);
			BigInteger N=pkey.getModulus();
			System.out.println("N:"+pkey.getModulus());
			System.out.println("N length:"+N.toString().length());
			System.out.println("e:"+pkey.getPublicExponent());
			System.out.println("d:"+prKey.getPrivateExponent());
		} catch (Exception e) {
